...
// La requ�te doit fournir au minimum l'ID_notice. Le type_obj peut �tre fourni soit par la requ�te, soit par le registre
// Le plugin de traitement est fourni dans le registre
// On peut fournir d'autres param�tres via la requ�te
...
// ces variables pourront �tre exploit�es via des alias ou des variables incluses.
...
$type_obj=$GLOBALS["affiche_page"]["parametres"]["type_obj"]; // par d�faut, on prend type_obj dans _parametres...
...
// on r�cup�re les �ventuelles variables optionnelles
