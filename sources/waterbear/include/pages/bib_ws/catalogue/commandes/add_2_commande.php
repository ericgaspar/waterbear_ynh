...
/**
 * Ce WS ajoute des champs exemplaires (997) aux notices d'un panier et cr�e les exemplaires correspondants
 * Ces exemplaires sont cr��s � partir d'un mod�le d�termin� via le champ 697$a. Si le 697$a vaut xxx, on appellera le plugin
 * $liste_plugins_crea_exemplaire["xxx"]
 * Par ailleurs, ce mod�le poura �tre enrichi du contenu des ss-champs 697 qui seront pass�s en param au plugin via $param_modele
 * Il sera �galemetn enrichi d'infos extraites de la notice biblio (pass�es en param via $param_biblio)
 * Les informations sont extraites de la notice biblio par des plugins indiqu�s dans [liste_infos_biblio]. A chaque plugin est associ� un mot clef
...
// 1) On r�cup�re la notice de commande
...
// 1.bibs) on r�cup�re 700$5 pour savoir si on a le droit de rajouter des notices
...
// 2) On r�cup�re le champ 697
// $a => mod�le exemplaire
// autres ss-champs => valeurs � ins�rer dans le mod�le
...
// 3) On r�cup�re les notices du panier
$liste_notices=array();
...
foreach ($liste_notices as $notice_biblio) { // pour chaque notice biblio
    ...
    // 4.a) on r�cup�re les infos int�ressantes de la notice biblio (cote, prix...)
    $param_biblio=array();
