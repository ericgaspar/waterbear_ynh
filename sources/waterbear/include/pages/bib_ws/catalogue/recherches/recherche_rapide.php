...
$url_tousmots=$GLOBALS["affiche_page"]["parametres"]["url_tousmots"];

// on d�termine le type de code barre
...
if ($type == "biblio") {
    ...
    $retour["resultat"]["url"]=str_replace("#cab#", $cab, $url_tousmots);
...
// on regarde s'il y a des r�sultats 
