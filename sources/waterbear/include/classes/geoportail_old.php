...
/**
 * 
 * ANCIENNE VERSION QUI FONCTIONNAIT AVEC L'IGN
 * 
 */
...
//die("");
    ...
    $opts = array('http'=>array('method'=>"GET",'timeout'=>"5", 'header'=>"User-Agent: Mozilla/5.0 (Windows NT 5.1; rv:31.0) Gecko/20100101 Firefox/31.0\r\n"."Referer: $referer\r\n"));
