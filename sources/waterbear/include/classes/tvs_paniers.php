...
class tvs_paniers {
    ...
    function create_node ($parametres) {
        ...
        // On regarde si un panier de m�me nom existe d�j�
        ...
        // On regarde s'il y a bien un r�pertoire parenr
        if ($chemin_parent != "") {
            $panier_parent=$this->get_panier_by_chemin($chemin_parent, $type_obj);
            if ($panier_parent == "") {
                $retour["erreur"]="Le r�pertoire $chemin_parent n'existe pas pour les objets $type_obj";
                $retour["succes"]=0;
                return ($retour);
            }
        }
        
        // on cr�e le panier dans a DB
        $nom=secure_sql($nom);
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // R�cup�re un panier � partir de son nom (+chemin parent et type_obj)
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // comme pr�c�dent, mais on fournit le chemin complet (il faut faire un explode pour trouver le nom et le chemin_parent)
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // R�cup�re un panier � partir de son ID
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // R�cup�re le contenu d'un r�pertoire � partir de son ID
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // MAJ les chemins parents des enfants d'un r�pertoire quand son nom change
    ...
    function save ($ID, $nom, $description) {
        // on supprime les caract�res sp�ciaux du nom du panier
        $nom=str_replace("'", " ", $nom);
        $nom=str_replace("\"", " ", $nom);
        $nom=str_replace("<", " ", $nom);
        $nom=str_replace("&", " ", $nom);
        ...
        // 1bis) on v�rifie qu'il n'y a pas de doublon
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Supprimer un panier (pas un r�pertoire)
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Ajouter un contenu dynamique � un panier
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Cr�e un nouveau panier avec un n� incr�mentiel
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Copie ou d�place (si $bool_suppr==1) un panier vers un r�pertoire de destination
    function copie_panier ($ID_panier, $chemin_dest, $bool_supr) {
        $retour=array();
        $retour["succes"]=1;
        $retour["resultat"]=array();
        // 1) on r�cup�re le panier
        ...
        // 2) on r�cup�re le r�pertoire de destination
        ...
        // 3) On copie le panier (ou r�peroire)
        ...
        // 4) Si r�pertoire, on copie les enfants
        if ($type == "repertoire") {
        ...
        // 5) on supprime le panier si d�placer
        if ($bool_supr == 1) {
