 ...
 */
function plugin_catalogue_catalogage_grilles_actions_grilles_monter_descendre_ss_champ ($parametres) {
    $retour=array();
    $retour["succes"]=1;
    ...
    $ID_rempl=$_SESSION["operations"][$ID_operation]["formulator"]->monte_descend_ss_champ ($ID_element, $sens);
