 ...
 * 
 * ON n'utilise plus Google mais le WS spécififque de wb (copie du BAN)
 * 
...
function plugin_catalogue_catalogage_grilles_actions_grilles_wizard_lecteur_geolocalisation ($parametres) {
    ...
    // 1) On r�cup�re les infos d'adresse
    $ss_champ_a="";
    $ss_champ_b="";
    $ss_champ_c="";
    $ss_champ_d="";
    ...
    $geoportail = new geoportail(array());
    $coordonnees=$geoportail->geocode($ss_champ_a, $ss_champ_b, $ss_champ_d, $ss_champ_c);
