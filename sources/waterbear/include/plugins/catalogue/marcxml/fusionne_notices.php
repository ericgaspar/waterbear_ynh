 ...
 * Les notices sont soit au format marcxml, soit en DOMXML (voir m�me XML string) soit simplement des ID de notices
 * en cas de modification de notices, c'est la notice A qui est conserv�e
 * VOIR DETAIL DANS fusion_marxml.php
 * 
 ...
 * @param SOIT [ID_notice_a] et [ID_notice_b] => ID de notices (la notice est r�cup�r�e dans la DB)
 * @param [type_obj]
 * @param [ID_notice] => si modification de notice. Peut correspondre � [ID_notice_a]
 * @param [format_retour] => "domxml" ou "marcxml" (d�faut)
 * @param [filtre]
 * @param [------][nettoie_a | nettoie_b] => supprime certains champs / sous-champs des notices (cf d�tail + bas)
 * @param [------][fusion] => fusionne les 2 notices (cf d�tail + bas)
 * 
 * ** DETAIL NETTOYAGE **
 ...
 * 
 * ** DETAIL FUSION **
 * @param [defaut_champ] => action par d�faut pour tous les champs (ajouter | remplacer | remplacer_sauf_vide | ajouter_si_existe_pas | inserer |supprimer)
