 ...
 * @param["defaut"] => valeur par défaut si l'ensemble des plugins ne retournent rien (ne pas confondre avec la valeur par défaut appliquée à chaque plugin)
...
function plugin_catalogue_marcxml_formate_plugins ($parametres) {
    ...
    if ($retour["resultat"]["texte"]=="" AND $parametres["defaut"] != "") {
        $retour["resultat"]["texte"]=$parametres["defaut"];
    }
