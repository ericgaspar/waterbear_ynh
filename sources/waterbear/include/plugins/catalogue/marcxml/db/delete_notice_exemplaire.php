 ...
 * 
 * 1. Regarde s'il y a des pr�ts ou des r�sas  li�s � cet exemplaire (lien implicite)
 * 1.a si NON : suppression classique
 * 1.b si OUI, maj des ss-champs �tat, pr�table... et enregistrement de la notice
 * 2. Mise � jour de la notice biblio : suppression du champ 997 et enregistrement
 * 
 * ce plugin peut être utilisé pour d'autres objets (abo)
 * 
...
function plugin_catalogue_marcxml_db_delete_notice_exemplaire ($parametres) {
    ...
    $plugin_maj_exe=$parametres["plugin_maj_exe"]; // plugin utilis� pour mettre � jour l'exemplaire q'il ne peut pas �tre simplement supprim� (�tat = pilon, pr�table = non ...)'
    ...
    // 3) On supprime le champ 997 de la notice biblio (si suppression compl�te)
