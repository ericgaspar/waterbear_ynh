...
function plugin_catalogue_periodiques_calcule_prochaine_date ($parametres) {
    ...
    $retour["resultat"]["date"]=date("Y-m-d"); // valeur du jour par d�faut
    ...
    // 1) on d�termine les d�lais de parution en fonction du mode de parution
    $delais=30*24*60*60; // par d�faut 30 jours (m�me irr�gulier); 
    if ($mode_parution == "HEBD") {
        ...
        $delais=28*24*60*60; // pour les mensuels on part sur 28 jours, puis on ajuste jusqu'� tomber sur le m�me jour de la semaine
    }
