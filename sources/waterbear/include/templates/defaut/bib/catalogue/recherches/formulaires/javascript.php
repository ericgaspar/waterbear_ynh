...
var recherchator; // l'objet global qui va g�rer tout
var panierator; // l'objet global qui va g�rer les paniers
...
// SI Stats
if (bool_stat == 1) {
    var statator; // l'objet global qui va g�rer les stats
    var manage_stats; // objet qui g�re les stats
...
function init () {
    ...
    recherchator.init_variable("nom_div_total", "total"); // � rendre param�trable � l'avenir ??
    ...
    // On attribue un n� d'onglet aux diff�rents objets
    recherchator.no_onglet_liste=1;
    recherchator.no_onglet_notice=2;
    
    // STATS
    if (bool_stat == 1) {
        // ces crit�res sont sp�cifiques � statator
        ...
        // ces crit�res sont les m�mes que recherchator  
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
// g�olocalisation : retourne une liste de coordonn�es
...
function init_onglets () {
    // 0) On g�n�re le HTML pour les icones des onglets :
    var html_icones_recherche=genere_icones(icones_recherche);
    html_icones_liste=genere_icones(icones_liste); // variable globale car doit �tre pass� � recherchator
    ...
    var tab_paniers=new YAHOO.widget.Tab({
        ...
        content: "<div id='div_barre_paniers'> <table><tr><td>"+html_icones_paniers+" </td><td><input id='input_panier_en_cours' readonly='readonly'/></td></tr></table></div><div id='div_tab_paniers'><table><tr><td> <div id='div_navigation_paniers'> navigation dans les paniers</div> </td><td> <div id='div_formulaire_paniers'><br> Emplacement : <br> <input id='input_chemin_parent' readonly='readonly'> <br><br> Nom : <br> <input id='input_nom_panier'>  <br><br> Description : <br><textarea id='textarea_description_panier'></textarea>  <br><br> Contenu : <br><textarea id='textarea_contenu_panier' readonly='readonly'></textarea></div> </td></tr></table></div>"
    });
