...
include_once($GLOBALS["tvs_global"]["conf"]["ini"]["include_path"]."fonctions/php7.php");
...
// On inclut les scripts qui DOIVENT �tre inclus avant le d�but de la session
// (s�rialisation des objets dans les sessions)
// Ces scripts sont d�finis dans config.php
$page_include="bib";
...
// TMP !! optimisation d�sactiv�e (temporairement ?) car compliqu� � g�rer dans le contexte metawaterbear et efficacit� � d�montrer 
...
// On ajoute la configuration d�finie dans le registre
registre_2_conf();
...
// V�rification des droits pour la page appel�e
...
// Gestion du tra�age des plugins
...
// LOG ... pas int�ressant pour l'instant, mais voir �ventuellement pour logger les affiche_page ????
