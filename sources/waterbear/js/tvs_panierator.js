...
// toto
    ...
    this.div_contenu=document.getElementById("textarea_contenu_panier");
    ...
    YAHOO.util.Connect.asyncRequest('GET', sUrl, callback);
     ...
     this.affiche_liste = function (liste) {
        ...
        } else { // sinon on focus sur le r�pertoire
        ...
        success: function(oResponse) {
            ...
            if (oResults.succes != 1) {
                ...
                //this_panierator.get_liste();
                 ...
                 this_panierator.div_contenu.value=oResults.resultat["contenu"];
    ...
    this.add_liste = function () {
        ...
        if (type=="dynamique") {
            ...
            if (this.id_appel != "") { // si la page a �t� appel�e par une autre, on cr�e un panier automatiquement
                var tableau=recherchator.formulaire_2_array();
                var contenu=recherchator.formulaire_2_json(tableau);
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // retourne le nom du panier en cours � window.opener
